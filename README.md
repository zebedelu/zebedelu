...
- Estudo de inteligência artificial e redes neurais
- Projetos práticos envolvendo automação e lógica

## Atualmente

- Aprofundando fundamentos de programação e estrutura de código
- Explorando aplicações de IA na prática
- Evoluindo consistência na construção de projetos
